    ...
    public handleUserAction(action: 'agree' | 'upload' | 'learnMore' | 'talk' | 'text', data?: IImage[]): void {
        switch (action) {
            ...
            case 'text':
                ...
                setTimeout(() => {
                    this._replaceLastMessage({
                        text: 'Я царь зверей. Я живу в африканских саваннах, где охраняю свою территорию и свою семью — прайд. Мы, львы, известны своей силой и грацией. Я могу громко рычать, чтобы дать знать о себе на расстоянии до 8 километров. А еще, мои львицы очень умелые охотники и добывают пищу для всей семьи. Что еще ты хочешь узнать обо мне?',
                        type: 'text',
                        sender: 'bot',
                    });
                }, 2000);
